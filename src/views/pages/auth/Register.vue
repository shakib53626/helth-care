                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="first_name" :class="{'white' : themeSetting.isDarkMode == 'dark'}">First Name <span class="text-danger">*</span></label>
                                <input type="first_name" id="first_name" class="form-control" placeholder="Enter first name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
